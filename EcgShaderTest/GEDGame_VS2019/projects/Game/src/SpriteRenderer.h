...
private:
	...
	ID3DX11EffectVectorVariable* m_CameraWorldUp;
	ID3DX11EffectVectorVariable* m_CameraWorldRight;

	// effect SRV from shader
	ID3DX11EffectShaderResourceVariable* m_GatlingSprite;
	ID3DX11EffectShaderResourceVariable* m_PlasmaSprite;
};
